// SIFEN Nota de Débito Electrónica Type Definitions v150
...
/**
 * Nota de Débito Electrónica - Complete structure for debit notes
 * Based on SIFEN Technical Manual v150 - DE_v150.xsd
 */
export interface NotaDebitoElectronica {
  /**
  ...
  documentoElectronico: {
     ...
     */
    camposFirmados: CamposFirmadosNDE;
  };
}
 ...
 * A001 | DE | Campos firmados del DE | Pagina 64
 */
export interface CamposFirmadosNDE {
  /**
 ...
 * C001 | gTimb | Datos del timbrado | Pagina 64
 */
export interface TimbradoNDE {
  /**
   * C002 | iTiDE | Tipo de Documento Electrónico | Pagina 64
   */
  tipoDocumento: number; // 6=Nota de débito electrónica
  /**
