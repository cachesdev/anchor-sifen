...
export interface RecibeLoteClient extends SoapClient {
    ...
    rEnvioLoteAsync(rEnvioLote: REnvioLote, options?: ISoapExOptions): Promise<[result: RResEnviLoteDe, rawResponse: any, soapHeader: any, rawRequest: any]>;
}

/** Create RecibeLoteClient */
export function createClientAsync(...args: Parameters<typeof soapCreateClientAsync>): Promise<RecibeLoteClient> {
