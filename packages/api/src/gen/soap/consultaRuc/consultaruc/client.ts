...
export interface ConsultaRucClient extends SoapClient {
    ...
    rEnviConsRUCAsync(rEnviConsRuc: REnviConsRuc, options?: ISoapExOptions): Promise<[result: RResEnviConsRuc, rawResponse: any, soapHeader: any, rawRequest: any]>;
}

/** Create ConsultaRucClient */
export function createClientAsync(...args: Parameters<typeof soapCreateClientAsync>): Promise<ConsultaRucClient> {
