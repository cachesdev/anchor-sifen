...
export interface ConsultaClient extends SoapClient {
    ...
    rEnviConsDeAsync(rEnviConsDeRequest: REnviConsDeRequest, options?: ISoapExOptions): Promise<[result: REnviConsDeResponse, rawResponse: any, soapHeader: any, rawRequest: any]>;
}

/** Create ConsultaClient */
export function createClientAsync(...args: Parameters<typeof soapCreateClientAsync>): Promise<ConsultaClient> {
