...
export interface ConsultaLoteClient extends SoapClient {
  ...
  rEnviConsLoteDeAsync(
    rEnviConsLoteDe: REnviConsLoteDe,
    options?: ISoapExOptions
  ): Promise<[result: RResEnviConsLoteDe, rawResponse: any, soapHeader: any, rawRequest: any]>;
}

/** Create ConsultaLoteClient */
export function createClientAsync(
  ...args: Parameters<typeof soapCreateClientAsync>
): Promise<ConsultaLoteClient> {
